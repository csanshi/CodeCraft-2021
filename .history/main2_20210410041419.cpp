...
const char* AB[] = {"A", "B"};
const string inputFilePaths[3] = {" ","training-data2/training-1.txt", "training-data2/training-2.txt"};
int testedFile = 1;
...
/////////////////////////////////////////////////////////////////////////////////
    ...
    /////////////////////////////////////////////// 两个首次适配函数提交结果不同。。。后来好像可以了（修改了新函数的bug）//////////////////////////
...
void solve(){
    int T, K = 1; cin >> T; // 最大1000 ，add操作不超过100000
