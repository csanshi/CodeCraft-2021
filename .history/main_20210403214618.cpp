...
/////////////////////////////////////////////////////////////////////////////////
        ...
        for(int i = 0; i < n-1; i++){
            ...
            for(auto& vm : server.vms){
                ...
                if(node == -1){ // 无处可插
                    ...
                    // vmToServer.insert(vm.first, {idx[toServer], node});
                    vmToServer.update(vm.first, {idx[toServer], node});
                    curMigrationNum++;
                }
            }
    ...
    void deploy0(string model, int id){
        ...
        if(idx != -1){ // 在已有的服务器中找到了
            ...
            vmToServer.insert(id, {idx, minRes.first});
        }else{ // 需要购买
            ...
            vmToServer.insert(id, {(int)(this->servers.size()-1), node});
        }
    }    
